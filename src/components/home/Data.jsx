    ...
    <div className="home__data">
      ...
      <div className="home__subtitle">
        ...
        <span className="ityped">
          <Typewriter
            options={{
              strings: ["full stack developer", "Web designer", "it-solutions"],
              autoStart: true,
              loop: true,
              pauseFor: 300,
            }}
      ...
      <p className="home__desciption">
        ...
        . have developed many website and apart from the I have been part of web
        design project, office work and as freelancer.
      </p>
